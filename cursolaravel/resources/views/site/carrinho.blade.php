...
<div class="row container">
              ...
              <tbody>
                <tr>
                  ...
                  <input type="hidden" name="id" value="{{$item->id}}">
                    <td><input type="number" name="quantity" value="{{$item->quantity}}" style="width: 40px; font-weight: 900;" class="white center" min="1"></td>
                  <td>
    ...
    <div class="card purple">
      <div class="card-content white-text">
        <span class="card-title">R$ {{number_format(\Darryldecode\Cart\Facades\CartFacade::getTotal(), 2, ',', '.')}}</span>
